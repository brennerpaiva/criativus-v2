...
export default function TopCriativosVisitasPage() {
    ...
    <div className="w-full h-full max-w-screen-xl mx-auto flex flex-col justify-around gap-6 mt-6 mb-6">
      <div className="flex my-auto justify-between">
        <div className="flex gap-2">
          <img src="eyes.gif" alt="eyes" className="w-10" />
          <h1 className="text-3xl font-bold text-center my-auto">Top Criativos - Visitas</h1>
        </div>
