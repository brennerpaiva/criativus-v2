...
// import { MetricChip, MetricChipsBar } from "@/components/business/filter/metrics-chips-bar.component";
...
//   const [metricsOrder, setMetricsOrder] = useState<MetricChip[]>([
//     { id: "tumbstock", label: "Thumb-stop" },
//     { id: "ctrLinkClick", label: "CTR (link click)" },
//   ]);
...
//           <h1 className="text-3xl font-bold my-auto">Custom Page</h1>
//         </div>
...
//               const metrics = metricsOrder.map((m) => {
//                 const def = METRIC_MAP[m.id as MetricKey];
//                 return {
//                   label: def.label,
